...
app.post("/send-email", async (req, res) => {
  ...
  //   html: `
  //     <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
  //       <h2 style="color: #E91E63; text-align: center;">Thank You for Reaching Out! 🌟</h2>
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
        <div style="text-align: center; margin-bottom: 20px;">
          <img src="https://static.dezeen.com/uploads/2018/06/lgbt-pride-flag-redesign-hero-1704x959.jpg" alt="Love for Pride Unity" style="max-width: 150px;">
        </div>
        <h2 style="color: #E91E63; text-align: center;">Thank You for Reaching Out! 🌟</h2>
        <p>Dear <strong>${Name}</strong>,</p>
        <p>We appreciate you taking the time to connect with <strong>Love for Pride Unity</strong>. Your message has been received, and our team will get back to you as soon as possible.</p>
